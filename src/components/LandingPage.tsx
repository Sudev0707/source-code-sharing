...
import { ArrowRight, Code2, Share2, Download, Eye, Zap, Shield, Globe } from "lucide-react";

const HeroSection = () => {
  return (
    <section className="relative min-h-[90vh] flex rounded-b-3xl mx-8  pt-16 justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-8 animate-fade-in">
            ...
            <span className="text-sm font-medium text-muted-foreground">The modern way to share code</span>
          </div>
  ...
  const features = [
    {
      ...
      description: "Full-featured code editor with syntax highlighting, auto-completion, and multiple themes.",
    },
    {
      icon: Share2,
      title: "Instant Sharing",
      description: "Share code files and snippets with a single link. Control visibility with public or private access.",
    },
    {
      icon: Download,
      title: "Download & Export",
      description: "Download your code files in any format. Export entire projects as ZIP archives.",
    },
    {
      icon: Eye,
      title: "Beautiful Previews",
      description: "Render HTML, Markdown, and more with live previews. Perfect for documentation.",
    },
    {
      icon: Shield,
      title: "Secure Storage",
      description: "Your code is encrypted and stored securely. Control who can view and edit your files.",
    },
    {
      icon: Globe,
      title: "Multi-Language Support",
      description: "Support for JavaScript, TypeScript, Python, Java, HTML, CSS, and 15+ more languages.",
    },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-foreground">
            Everything you need to <span className="gradient-text">share code</span>
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            A complete platform for developers to create, organize, and share their code with the world.
          </p>
        </div>
          ...
          <div className="p-3 rounded-2xl overflow-hidden shadow-card bg-slate-100 border-border/50 animate-scale-in">
            ...
            <div className="bg-editor rounded-t-md flex items-center justify-between px-4 py-3 border-b border-editor-line">
              <div className="flex items-center gap-2">
                ...
                <span className="ml-4 text-editor-foreground/60 text-sm font-mono">welcome.ts</span>
              </div>
              <div className="flex items-center gap-2">
                <Button variant="ghost" size="sm" className="text-editor-foreground/60 hover:text-editor-foreground h-7">
                ...
                <code>
                  {sampleCode.split('\n').map((line, i) => (
                    <div key={i} className="flex">
                      <span className="text-editor-foreground/30 w-8 select-none">{i + 1}</span>
        ...
        <div className="max-w-3xl mx-auto text-center p-12 rounded-3xl glass border border-border/50 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-muted-foreground mb-8 max-w-lg mx-auto">
              Join thousands of developers who use SourceShare to organize and share their code snippets.
            </p>
      ...
      <div className="container mx-auto px-2 md:px-0 lg:px-4">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-semibold text-foreground">SourceShare</span>
          </div>
